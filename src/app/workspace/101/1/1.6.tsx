    ...
    ideas: [
        {
            ...
            theoreticalSteps: [
                {
                    ...
                    stepDescription: "عند إيجاد نهاية دالة كسرية، نوزع النهاية على البسط والمقام أولاً، ثم نوزعها على عمليات الجمع والطرح والأسس داخل الحدود."
                },
                {
                    stepTitle: "Step 2: التعويض المباشر",
                    stepDescription: "نعوض بقيمة x في الحدود المبسطة للبسط والمقام، بشرط ألا يكون المقام مساوياً للصفر."
                }
            ],
            ...
            practiceQuestion: {
                ...
                questionExplanation: "بتوزيع النهاية على البسط والمقام ثم التعويض المباشر بـ x يساوي -1: البسط (-1 التكعيب ناقص 3 في (-1) التربيع زائد 2) يساوي (-1 ناقص 3 زائد 2) ويساوي -2. المقام (4 ناقص 2 في -1) يساوي (4 زائد 2) ويساوي 6. إذن الناتج سالب 2 على 6 وبعد الاختصار يصبح سالب 1 على 3."
            }
        },
        {
            id: "idea-2",
            ...
            theoreticalSteps: [
                {
                    ...
                    stepDescription: "التركيز على النقطة الفاصلة التي تتغير عندها القاعدة الجبرية للدالة."
                },
                {
        ...
        },
        {
            ...
            theoreticalSteps: [
                {
                    stepTitle: "Step 1: كشف حالة عدم التعيين ووجود الجذور",
                    stepDescription: "عند التعويض المباشر في النهاية وتنتج كمية غير معينة (0/0) مع وجود جذور تربيعية في البسط أو المقام أو كليهما، لا يمكن التعويض مباشرة."
                },
                {
                    stepTitle: "Step 2: الضرب في المرافق الجبري والاختصار",
                    stepDescription: "نضرب البسط والمقام في مرافق الحد الجذري (أو مرافق كل من البسط والمقام إذا وجد جذر في الطرفين) للتخلص من الجذور، ثم نختصر العامل الصفري المشترك ونعوض بقيمة x."
                }
            ],
        ...
        },
        {
            ...
            theoreticalSteps: [
                {
                    stepTitle: "Step 1: استخدام فرضية أو تعريف دالة جديدة للمقدار المعطى",
                    stepDescription: "عند إعطاء نهاية كسر يحتوي على دالة مجهولة ويساوي قيمة ثابتة، نفرض أن الكسر بأكمله هو دالة جديدة نلجأ لخصائصها للربط بين البسط والمقام."
                },
                {
                    stepTitle: "Step 2: فصل الحدود وحل المعادلة الناتجة",
                    stepDescription: "نضرب الطرفين في المقام، وبما أن نهاية المقام تساوي صفراً عند التعويض، فإن ناتج ضرب الطرف الأيمن يصبح صفراً، وننقل الثوابت لإيجاد نهاية الدالة المطلوبة."
                }
            ],
