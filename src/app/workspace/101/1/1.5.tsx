...
export const chapter1_5Data: ChapterData = {
    ...
    ideas: [
        ...
        },
        {
            ...
            theoreticalSteps: [
                {
                    stepTitle: "مفهوم خطوط التقارب الرأسية",
                    stepDescription: "يكون للدالة خط تقارب رأسي عند القيمة x = a إذا اقتربت قيمة الدالة من ما لانائي موجب أو سالب عندما تقترب x من a من جهة اليمين أو اليسار."
                },
                {
                    stepTitle: "خطوات الحل السريع",
                    stepDescription: "1. نوجد أصفر المقام بمساواته بالصفر (x = a). 2. نحسب النهاية عندما تقترب x من a من اليمين واليسار. 3. إذا كانت النتيجة تساوي (موجب أو سالب ما لانائي)، إذن يوجد خط تقارب رأسي عند هذه القيمة."
                }
            ],
            videoUrl: "https://www.youtube.com/embed/o7rjD4v5oN8",
            practiceQuestion: {
                questionText: "أوجد معادلتي خطي التقارب الرأسيين للدالة التالية باستخدام النهايات:",
                ...
                questionExplanation: "شرح الحل:<br>نضع المقام يساوي صفر: x² - 4 = 0، إذن (x - 2)(x + 2) = 0، ومنها القيم هي x = 2 و x = -2. عند حساب النهاية عندما تقترب x من هذين العددين يكون الناتج ما لانائي، إذن هما خطا التقارب الرأسيان."
            }
        }
    ]
};